...
function Header(){
      ...
      return (
        ...
        <header className="bg-[#1C1E53] sticky top-0 z-10">
      <div className="wrapper">
        <nav className="lg:flex justify-between items-center ">
          <a href="/" className="py-[33.5px] inline-block">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_2832_312)">
                <path
          ...
          <a
            ...
            className="lg:hidden absolute right-2.5 top-7"
            onclick="toggleMenu()"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <ul className="mobile-menu gap-x-8 items-center hidden lg:flex">
            <li>
              <a
                href="/"
